<?php require '../inc/header.php';?>
		...
		<div id="page-top-section" class="p-3 p-md-5 text-center">
            <h1 class="display-4 font-weight-normal text-white">Veille Technologique</h1>
        </div>
		...
		<div id="veille" class="container">
			<div class="row">
				<div class="col-lg-9 m-auto text-justify">
                    ...
                    <div class="my-4">
                        <h2 class="h4 mb-3">Méthodes, supports et outils utilisés</h3>
                        ...
                        <ul>
                            <li>Les <b>agrégateurs de contenus</b>. Ils permettent à l'utilisateur de gérer et personnaliser ses abonnements à des flux RSS. Exemples : Netvibes, Feedly, Google News, Flipboard, Peartrees.</li>
                    ...
                    <div class="my-4">
                        <h2 class="h4 mb-3">Sujet principal de la veille</h3>
                        <p>--blablabla--</p>
                    </div>
                    <hr/>
                    
                    <div class="my-4">
                        <h2 class="h4 mb-3">Sources d'information</h3>
                    ...
                    <div class="my-4">
                        <h2 class="h4 mb-3">Conclusion de la veille</h3>
                        <p>--blablabla--</p>
                    </div>
