        ...
        <div class="col-xl-9">
            ...
            <div class="my-5">
                ...
                <div class="m-3">
                    ...
                    <p class="text-justify">
                        ...
                        Via Santé est une petite entreprise de moins de 10 employés, dont la marque est La Boutique des Jambes. Elle vend des produits pour le bien-être des jambes : bas de contention, chaussettes sans élastique, compléments alimentaires et accessoires.<br>
                        À mon arrivée, l'entreprise n'a pas de site internet. Elle fait de la vente à distance, envoie ses catalogues et offres promotionnelles par le biais La Poste, et fait de la publicité dans des magazines principalement.
                    </p>
                </div>
                <div class="m-3">
                    ...
                    <p class="text-justify">
                        ...
                        En 2016, je propose de développer un site de vente en ligne. Ma demande est acceptée et j'arrête la préparation de commandes pour me consacrer uniquement au développement et à la gestion du site de e-commerce.
                    </p>
                </div>
            </div>
            ...
            <div class="my-5">
                ...
                <div class="m-3">
                    ...
                    <P class="text-justify">
                        J'ai fait le choix de développer le site via le <a href="https://fr.wikipedia.org/wiki/Syst%C3%A8me_de_gestion_de_contenu" target="_blank" rel="noopener noreferrer">CMS*</a> Prestashop, qui est une application web open source Française axée sur la création de boutiques de vente en ligne, ce qui correspond parfaitement à mes attentes.<br>
                        D'autres CMS proposant plus ou moins les mêmes services sont disponibles. Mais le fait que Prestashop soit open source, dispose d'une grande communauté, de forums d'entraide et qu'il soit mis à jour régulièrement m'ont conforté dans ce choix.
                    </P>
                </div>
                <div class="m-3">
                    <h4 class="h5">Formation personnelle</h4>
                    <P class="text-justify">
                        Mes connaissances dans le développement web se limitaient au HTML / CSS en 2016. J'ai donc commencé à étudier les différents langages et technologies qui me seraient utiles : PHP, JavaScript, approfondissement du HTML / CSS, étude de la documentation Prestashop et des fondamentaux liés à la mise en place d'un site.<br>
                        Vu que cela me passionnait et que je voulais avancer rapidement, j'étudiais également chez moi après le travail, pour me perfectionner.<br>
                        C'est à ce moment-là que j'ai fait le choix m'inscrire à la formation à distance du BTS SIO option SLAM, par le biais du CNED. Parce que je me suis rendu compte qu'en étant débutant et en essayant de me former sur internet, l'apprentissage se faisait de manière déstructurée et j'avais l'impression de ne pas évoluer rapidement.
                    </P>
                </div>
                <div class="m-3">
                    ...
                    <P class="text-justify">
                        ...
                        J'ai mis en place et me suis initié à l'utilisation de Git et GitHub, qui m'ont par la suite servi à de multiples reprises : pour le travail collaboratif, la récupération de fichiers après une mauvaise manipulation ou la création de branches secondaires pour faire des tests.
                    </P>
                </div>
                <div class="m-3">
                    ...
                    <ul>
                        ...
                        <li>Mettre à jour les fichiers qui comportent des informations d'accès à la base de données</li>
                    </ul>
                    <P class="text-justify">Pour plus de détails, vous pouvez voir le fichier Word que j'avais fait, qui liste les différentes étapes pour copier le site en local (pour le mettre en ligne, il faut faire la manipulation inverse) :</P>
                ...
                <div class="m-3">
                    <h4 class="h5">Configuration et test de modules</h4>
                    <P class="text-justify">
                ...
                <div class="m-3">
                    <h4 class="h5">Perfectionnement du site et ajout de nouveaux modules</h4>
                    <P class="text-justify">
                        ...
                        <br>
                        Avec ces connaissances, j'ai codé la plupart des pages du site en PHP et HTML pour plus de personnalisation et d'optimisation, plutôt que d'utiliser l'outil <a href="https://fr.wikipedia.org/wiki/What_you_see_is_what_you_get" target="_blank">WYSIWYG*</a> proposé dans le back-office de Prestashop, qui génère beaucoup de code inutile et qui pénalise le site pour le référencement.<br>
                        <br>
                        J'ai aussi créé un module pour la page de contact, car les options proposées par le module Prestashop étaient trop limitées.<br>
                        Pour la création de ce module, je me suis référé à la <a href="https://devdocs.prestashop.com/" target="_blank" rel="noopener noreferrer">documentation Prestashop destinée aux développeurs*</a>.<br>
                        J'ai repris le template du module contactform d'origine et j'y ai ajouté une carte indiquant les coordonnées de l'entreprise, une div de type "alert" avec un lien vers la FAQ et le système reCAPTCHA de Google qui sert à limiter les courriers indésirables.<br>
                ...
                <div class="m-3">
                    ...
                    <P class="text-justify">
                        Lors de la création du site, Prestashop était en version 1.6. Quelques mois plus tard, la version 1.7 est sortie. En me documentant, j'ai vu que cette nouvelle version comportait beaucoup d'améliorations et corrigeait des failles de sécurité, cela valait donc le coup de faire la mise à jour.<br>
                        J'ai d'abord fait la mise à jour en local pour tester / adapter les différents modules et la base de données à cette nouvelle version, puis je l'ai mis en production. Au passage, j'ai aussi modifié la version de PHP sur l'hébergement OVH du site, en passant de la version 5.6 à la version 7.0, qui est plus performante et sécurisée.
                    </P>
                    <p class="text-justify">
                        Quelques jours après avoir mis le site en ligne, des clients se sont plaints d'une anomalie liée à un mauvais calcul des réductions lors du paiement.<br>
                        Le point commun entre ces clients est qu'ils avaient utilisé PayPal comme mode de paiement.<br>
                        Après avoir fait des recherches et analysé le code pas à pas sur l'IDE NetBeans, grâce à l'outil Xdebug, j'en ai déduit que le problème venait du fait que les remises ne se cumulaient pas, au niveau du montant total du panier, lorsqu'il y avait plusieurs promotions.<br>
            ...
            <div class="my-5">
                ...
                <P class="text-justify m-3">
                    Fin 2018, mon employeur m'a demandé de créer un second site de vente en ligne, pour une société qu'il sous-traite, dont la marque est "Sur le Sentier des Bergers". Cette marque propose des produits d'épicerie fine et fait de la vente aux professionnels exclusivement (B2B). La création d'un site de e-commerce est une opportunité, pour cette entreprise, de se lancer dans la vente aux particuliers.<br>
                    Pour créer ce site, j'ai repris le même procédé que pour le site de "La Boutique des Jambes" : j'ai installé de Prestashop en local, créé le site, puis une fois prêt, je l'ai mis en ligne.
                </P>
            </div>
            ...
            <div class="my-5">
                ...
                <P class="text-justify m-3">
                    En octobre 2019, la gérante de la société dont la marque est "Sur le Sentier des Bergers" m'a demandé de créer un site destiné à la vente aux professionnels (B2B), qui est le cœur de son activité.<br>
                    Ce site doit répondre à des besoins spécifiques, différents des sites destinés à la vente aux particuliers que j'avais créés jusqu'à présent. Les modules intégrés à Prestashop étant limités, j'ai moi-même modifié des modules ou fichiers template, quand je le pouvais, sinon j'ai cherché des modules sur la plateforme de vente de Prestashop.<br>
                    Voici les différents cas d'utilisation auxquels le site répond :
                </P>
                <ul>
            ...
            <div class="my-5">
                ...
                <p class="text-justify m-3">
                    Lorsque j'ai dû gérer et travailler sur 3 sites simultanément, j'ai très vite été dépassé par les différentes demandes et tâches à effectuer.<br>
                ...
                <p class="text-justify">
                    Pour mettre en place cette méthode, j'ai utilisé Trello pour lister et organiser les tâches, selon leurs degrés d'urgence/importance. Et pour ce qui est de la répartition de ces tâches dans le temps, j'ai utilisé Google Agenda.<br>
                    L'utilisation d'application web comme celles-ci est très pratique pour le travail collaboratif. Elles permettent à d'autres acteurs du projet de les visualiser et les modifier facilement.
                </p>
            </div>
            ...
            <div class="my-5">
                ...
                <div class="m-3">
                    ...
                    <ul>
                        <li>Réflexions et modifications liées à l'expérience utilisateur sur le site (UX), modification et réagencement de la plupart des pages du site pour améliorer la clarté. Surtout sur le site de La Boutique des Jambes, où l'âge moyen des utilisateurs est élevé. Il faut simplifier et aller à l'essentiel.</li>
                        <li>Personnalisation des factures : modification du code des factures pour un affichage personnalisé.</li>
                    </ul>
                </div>
                <div class="m-3">
                    <p class="text-justify">Sauvegardes et résolution de problème : </p>
                    <ul>
                        <li>Sauvegarde quotidienne du site et de la base de données, pour pouvoir restaurer les sites en limitant la perte de données, en cas de problème.</li>
                        <li>Lors de certaines installations ou mises à jour de module, il est arrivé que des problèmes surviennent. Dans ce cas, j'essayais de résoudre ce problème par moi-même, sinon je contactais le développeur de ce module.</li>
                    </ul>
                </div>
                <div class="m-3">
                ...
                <div class="m-3">
                    ...
                    <ul>
                        ...
                        <li>le référencement payant (SEA) : création de campagnes via Google Ads, codage de pages de destination (landing page) vers des promotions attrayantes, spécialement mises en place pour l'acquisition de nouveaux clients. Avec l'aide d'un conseiller de chez Google, avec qui je faisais un point tous les mois.</li>
                        <li>la visibilité sur les réseaux sociaux (SMO) : création d'une page Facebook et Instagram et publication de contenu,</li>
                        <li>la création de campagnes e-mailing et de newsletters en se servant de notre base de données : modification du code des e-mails d'origine.</li>
                    </ul>
                </div>
                <div class="m-3">
                    ...
                    <ul>
                        ...
                        <li>Guide expliquant comment changer de promotion sur le site :</li>
                        <div class="my-2 mb-3">
