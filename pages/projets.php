...
<div id="projets">
    ...
    <div id="sites-web" class="container">
        <div class="row">
            <div class="col-lg-9 m-auto">
    ...
    <div id="projets-personnels" class="container">
        ...
        <div class="row row-cols-1 row-cols-md-2 text-center mb-5">
            <div class="col mb-4">
                <div class="card">
                    <div>
                        <img src="/img/projets/android-studio.png" class="card-img" alt="Android Studio logo">
                    </div>
                    <div class="card-footer border-top">
            ...
            <div class="col mb-4">
                <div class="card">
                    <div>
                        <img src="/img/projets/php-netbeans-logos.png" class="card-img" alt="PHP logo">
                    </div>
                    <div class="card-footer border-top">
            ...
            <div class="col mb-4">
                <div class="card">
                    <div>
                        <img src="/img/projets/synology.png" class="card-img" alt="Synology logo">
                    </div>
                    <div class="card-footer border-top">
                        <h3 class="h5 card-title">NAS</h3>
                        <p class="card-text">
                            - Gestion des sauvegardes et versionning<br>
                            - Virtualisation classique ou via conteneur (Docker)<br>
                            - Serveur web
                        </p>
                    </div>
                </div>
