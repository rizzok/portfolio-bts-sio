<?php require 'inc/header.php';?>
        ...
        <div class="container py-5">
            ...
            <div class="card mb-3">
                <a href="competences/outils-de-versioning-git-et-github.php">
                ...
                <div class="card-footer text-center">
                    ...
                    <a href="competences/outils-de-versioning-git-et-github.php" class="btn btn-primary">Afficher la page</a>
                </div>
            </div>
